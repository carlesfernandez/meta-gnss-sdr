...
[OpenEmbedded Layer Index](https://layers.openembedded.org/layerindex/branch/zeus/layer/meta-gnss-sdr/).
...
2.  Initialize a Repo client.
    ...
    Tell Repo where to find the manifest
        ...
        $ repo init -u https://github.com/carlesfernandez/oe-gnss-sdr-manifest.git -b zeus
